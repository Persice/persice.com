...
import { ReligiousViewsService, PoliticalViewsService } from '../../shared/services/index';

@Component({
  selector: 'prs-edit-personalinfo',
  template: <any>require('./edit-personalinfo.html'),
  directives: [EditAboutComponent, EditFooterComponent],
...
export class EditPersonalInfoComponent implements AfterViewInit, OnInit {
  ...
  private politicalList: any[] = [];
  private religionList: any[] = [];

  private politicalMy: any[] = [];
  private religionMy: any[] = [];
