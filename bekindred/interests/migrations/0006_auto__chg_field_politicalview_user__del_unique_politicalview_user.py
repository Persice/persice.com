...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PoliticalView', fields ['user']
        db.delete_unique(u'interests_politicalview', ['user_id'])


        # Changing field 'PoliticalView.user'
        db.alter_column(u'interests_politicalview', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_facebook.FacebookCustomUser']))

    def backwards(self, orm):

        # Changing field 'PoliticalView.user'
        db.alter_column(u'interests_politicalview', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['django_facebook.FacebookCustomUser'], unique=True))
        # Adding unique constraint on 'PoliticalView', fields ['user']
        db.create_unique(u'interests_politicalview', ['user_id'])
