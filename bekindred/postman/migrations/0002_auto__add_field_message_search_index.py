...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.search_index'
        db.add_column(u'postman_message', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.search_index'
        db.delete_column(u'postman_message', 'search_index')
