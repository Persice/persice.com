...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'postman_message', (
            ...
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'sent_messages', null=True, to=orm['django_facebook.FacebookCustomUser'])),
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'received_messages', null=True, to=orm['django_facebook.FacebookCustomUser'])),
            ...
            ('moderation_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'moderated_messages', null=True, to=orm['django_facebook.FacebookCustomUser'])),
    ...
    models = {
        ...
        u'postman.message': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'moderation_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'moderated_messages'", 'null': 'True', 'to': u"orm['django_facebook.FacebookCustomUser']"}),
            ...
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'received_messages'", 'null': 'True', 'to': u"orm['django_facebook.FacebookCustomUser']"}),
            ...
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'sent_messages'", 'null': 'True', 'to': u"orm['django_facebook.FacebookCustomUser']"}),
