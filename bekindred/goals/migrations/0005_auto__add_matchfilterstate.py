...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MatchFilterState'
        db.create_table(u'goals_matchfilterstate', (
        ...
        db.send_create_signal(u'goals', ['MatchFilterState'])


    def backwards(self, orm):
        # Deleting model 'MatchFilterState'
        db.delete_table(u'goals_matchfilterstate')
