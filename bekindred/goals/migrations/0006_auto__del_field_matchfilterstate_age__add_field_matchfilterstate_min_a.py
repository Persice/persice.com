...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MatchFilterState.age'
        db.delete_column(u'goals_matchfilterstate', 'age')

        # Adding field 'MatchFilterState.min_age'
        db.add_column(u'goals_matchfilterstate', 'min_age',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=3),
                      keep_default=False)

        # Adding field 'MatchFilterState.max_age'
        db.add_column(u'goals_matchfilterstate', 'max_age',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MatchFilterState.age'
        db.add_column(u'goals_matchfilterstate', 'age',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=6),
                      keep_default=False)

        # Deleting field 'MatchFilterState.min_age'
        db.delete_column(u'goals_matchfilterstate', 'min_age')

        # Deleting field 'MatchFilterState.max_age'
        db.delete_column(u'goals_matchfilterstate', 'max_age')
    ...
    models = {
        ...
        u'goals.matchfilterstate': {
            'Meta': {'object_name': 'MatchFilterState'},
            ...
            'max_age': ('django.db.models.fields.CharField', [], {'max_length': '4'}),
            'min_age': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_facebook.FacebookCustomUser']"})
        },
        u'goals.offer': {
