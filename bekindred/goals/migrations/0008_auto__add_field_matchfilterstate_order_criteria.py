...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MatchFilterState.order_criteria'
        db.add_column(u'goals_matchfilterstate', 'order_criteria',
                      self.gf('django.db.models.fields.CharField')(default='distance', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MatchFilterState.order_criteria'
        db.delete_column(u'goals_matchfilterstate', 'order_criteria')
    ...
    models = {
        ...
        u'goals.subject': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '300'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
