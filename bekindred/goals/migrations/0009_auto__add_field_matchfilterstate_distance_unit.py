...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MatchFilterState.distance_unit'
        db.add_column(u'goals_matchfilterstate', 'distance_unit',
                      self.gf('django.db.models.fields.CharField')(default='miles', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MatchFilterState.distance_unit'
        db.delete_column(u'goals_matchfilterstate', 'distance_unit')
