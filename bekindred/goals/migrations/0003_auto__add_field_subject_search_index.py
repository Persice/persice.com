...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subject.search_index'
        db.add_column(u'goals_subject', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subject.search_index'
        db.delete_column(u'goals_subject', 'search_index')
