...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'goals_subject', 'description', self.gf('django.db.models.fields.CharField')(unique=True, max_length=300))

    def backwards(self, orm):

        # Changing field 'Subject.description'
        db.alter_column(u'goals_subject', 'description', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True))
