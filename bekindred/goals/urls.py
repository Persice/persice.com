...
from .views import GoalView, OfferView, my_page, biography_update, goal_delete, \
    goal_update, offer_delete, offer_update, CreateGoalView, CreateOfferView, MatchView, search_form, edit_my_page, close_login_popup
...
urlpatterns = patterns('',
    ...
    url(r'^close_login_popup/$', close_login_popup, name='close_login_popup'),
)
