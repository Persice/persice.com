...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Friend.updated_at'
        db.alter_column(u'friends_friend', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'friends.friend': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 29, 0, 0)'})
        },
