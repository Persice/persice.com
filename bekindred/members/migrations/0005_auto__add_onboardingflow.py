...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OnBoardingFlow'
        db.create_table(u'members_onboardingflow', (
        ...
        db.send_create_signal(u'members', ['OnBoardingFlow'])


    def backwards(self, orm):
        # Deleting model 'OnBoardingFlow'
        db.delete_table(u'members_onboardingflow')
    ...
    models = {
        ...
        u'members.onboardingflow': {
            'Meta': {'object_name': 'OnBoardingFlow'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_complete': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['django_facebook.FacebookCustomUser']", 'unique': 'True'})
        },
        u'members.usersession': {
