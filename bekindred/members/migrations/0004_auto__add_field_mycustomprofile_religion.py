...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MyCustomProfile.religion'
        db.add_column(u'members_mycustomprofile', 'religion',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MyCustomProfile.religion'
        db.delete_column(u'members_mycustomprofile', 'religion')
