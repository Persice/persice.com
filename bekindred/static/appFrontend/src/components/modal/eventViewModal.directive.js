(function() {
   ...
   * @ngInject
   */
  function EventViewModalController($scope, USER_ID, EventsFactory, USER_PHOTO, $state, $rootScope, $log, $window, moment, angularMomentConfig, notify, MembersFactory, $geolocation, $filter, $timeout, EventsConnections, $q, EventsAttendees, lodash, USER_FACEBOOK_ID, EventChatFactory, $sce, $resource) {
    var vm = this;
    vm.showMobile = false;
    ...
    function updateEvent(level, list) {
      ...
      EventsFactory.update({
        ...
        function(success) {
          vm.eventEdit.access_level = success.access_level;
          vm.eventEdit.access_user_list = success.access_user_list;
        },
        function(error) {
    ...
    function openInvitations() {
      ...
      vm.invitationsOptions.attendingPref = vm.eventEdit.access_level;
      vm.getConnections();
      vm.getInvitedPeople();
    }
