...
describe('E2E: login page', function() {
    ...
    it('should have a title', function() {
        expect(browser.getTitle()).toEqual('persice - User Login');
    });
    ...
    it('should include logo image', function() {
        ...
        expect(page.logoImg.getAttribute('src')).toMatch(/\/static\/img\/persice\-logo\.png$/);
    });
    ...
    it('should include login notice', function() {
        ...
        expect(page.loginNotice.getText()).toBe('persice will never share your personal information with anyone. And, we will never post to a social network on your behalf.');
    });
