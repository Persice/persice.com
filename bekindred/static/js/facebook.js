...
facebookClass.prototype = {
  ...
  connect: function(formElement, requiredPerms) {
    ...
    this.connectLoading(gettext('A Facebook pop-up window has opened, please follow the instructions to sign in.'));
    var scope = this;
      ...
      var html = '<div id="facebook_shade"></div>\
                <div id="facebook_wrapper">\
                    <div id="facebook_lightbox">\
                        ...
                        <img id="facebook_loading" src="/static/img/facebook_loading.gif" alt="..."/>\
