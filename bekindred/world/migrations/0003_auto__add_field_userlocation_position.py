...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserLocation.position'
        db.add_column(u'world_userlocation', 'position',
                      self.gf('geoposition.fields.GeopositionField')(default=[0, 0], max_length=42, blank=True),
                      keep_default=False)
        # for user_location in orm.UserLocation.objects.all():
        #     user_location.position = [user_location.geometry.x, user_location.geometry.y]
        #     user_location.save()


    def backwards(self, orm):
        # Deleting field 'UserLocation.position'
        db.delete_column(u'world_userlocation', 'position')
