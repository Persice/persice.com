...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.rsvp'
        db.add_column(u'events_membership', 'rsvp',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membership.rsvp'
        db.delete_column(u'events_membership', 'rsvp')
    ...
    models = {
        ...
        u'events.membership': {
            ...
            'rsvp': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True'}),
