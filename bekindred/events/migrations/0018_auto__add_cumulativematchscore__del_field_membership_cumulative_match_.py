...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Membership.cumulative_match_score'
        db.delete_column(u'events_membership', 'cumulative_match_score')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Membership.cumulative_match_score'
        db.add_column(u'events_membership', 'cumulative_match_score',
    ...
    models = {
        ...
        u'events.cumulativematchscore': {
            'Meta': {'object_name': 'CumulativeMatchScore'},
        ...
        u'events.membership': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 25, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_facebook.FacebookCustomUser']"})
        }
    }
