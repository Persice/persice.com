...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookEvent.location_name'
        db.add_column(u'events_facebookevent', 'location_name',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookEvent.location_name'
        db.delete_column(u'events_facebookevent', 'location_name')
    ...
    models = {
        ...
        u'events.membership': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 9, 15, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_facebook.FacebookCustomUser']"})
        }
    }
