...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_event', 'zipcode', self.gf('django.db.models.fields.CharField')(max_length=7, null=True))

    def backwards(self, orm):

        # Changing field 'Event.zipcode'
        db.alter_column(u'events_event', 'zipcode', self.gf('django.db.models.fields.IntegerField')(max_length=7, null=True))
    ...
    models = {
        ...
        u'events.membership': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 24, 0, 0)'}),
