...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.access_user_list'
        db.add_column(u'events_event', 'access_user_list',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.access_user_list'
        db.delete_column(u'events_event', 'access_user_list')
    ...
    models = {
        ...
        u'events.membership': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 23, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_facebook.FacebookCustomUser']"})
        }
    }
