...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.event_photo'
        db.add_column(u'events_event', 'event_photo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.event_photo'
        db.delete_column(u'events_event', 'event_photo')
    ...
    models = {
        ...
        u'events.membership': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 3, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_facebook.FacebookCustomUser']"})
        }
    }
