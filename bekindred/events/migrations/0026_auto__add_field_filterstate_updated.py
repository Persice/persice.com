...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilterState.updated'
        db.add_column(u'events_filterstate', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FilterState.updated'
        db.delete_column(u'events_filterstate', 'updated')
    ...
    models = {
        ...
        u'events.membership': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 24, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_facebook.FacebookCustomUser']"})
        }
    }
