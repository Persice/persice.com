...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CumulativeMatchScore', fields ['user', 'event']
        db.delete_unique(u'events_cumulativematchscore', ['user_id', 'event_id'])

        # Deleting model 'CumulativeMatchScore'
        db.delete_table(u'events_cumulativematchscore')


        # Changing field 'Event.event_photo'
        db.alter_column(u'events_event', 'event_photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Adding model 'CumulativeMatchScore'
        db.create_table(u'events_cumulativematchscore', (
        ...
        db.send_create_signal(u'events', ['CumulativeMatchScore'])

        # Adding unique constraint on 'CumulativeMatchScore', fields ['user', 'event']
        db.create_unique(u'events_cumulativematchscore', ['user_id', 'event_id'])


        # Changing field 'Event.event_photo'
        db.alter_column(u'events_event', 'event_photo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'events.membership': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 19, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_facebook.FacebookCustomUser']"})
        }
    }
