...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Membership.is_invited'
        db.add_column(u'events_membership', 'is_invited',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Membership.is_invited'
        db.delete_column(u'events_membership', 'is_invited')
    ...
    models = {
        ...
        u'events.membership': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 15, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_facebook.FacebookCustomUser']"})
        }
    }
