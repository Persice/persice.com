...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventFilterState.cumulative_match_score'
        db.add_column(u'events_eventfilterstate', 'cumulative_match_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventFilterState.cumulative_match_score'
        db.delete_column(u'events_eventfilterstate', 'cumulative_match_score')
    ...
    models = {
        ...
        u'events.membership': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 18, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_facebook.FacebookCustomUser']"})
        }
    }
