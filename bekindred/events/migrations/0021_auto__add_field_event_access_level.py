...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.access_level'
        db.add_column(u'events_event', 'access_level',
                      self.gf('django.db.models.fields.CharField')(default=('PUBLIC', 'public'), max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.access_level'
        db.delete_column(u'events_event', 'access_level')
    ...
    models = {
        ...
        u'events.membership': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 21, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_facebook.FacebookCustomUser']"})
        }
    }
