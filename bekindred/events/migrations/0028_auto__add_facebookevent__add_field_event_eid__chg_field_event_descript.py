...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'events_facebookevent', (
            ...
            ('rsvp_status', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('owner', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('attending_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
    ...
    models = {
        ...
        u'events.membership': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 9, 8, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_facebook.FacebookCustomUser']"})
        }
    }
