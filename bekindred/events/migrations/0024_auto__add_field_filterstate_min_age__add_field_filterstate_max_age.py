...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilterState.min_age'
        db.add_column(u'events_filterstate', 'min_age',
                      self.gf('django.db.models.fields.CharField')(default=25, max_length=3),
                      keep_default=False)

        # Adding field 'FilterState.max_age'
        db.add_column(u'events_filterstate', 'max_age',
                      self.gf('django.db.models.fields.CharField')(default=60, max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FilterState.min_age'
        db.delete_column(u'events_filterstate', 'min_age')

        # Deleting field 'FilterState.max_age'
        db.delete_column(u'events_filterstate', 'max_age')
    ...
    models = {
        ...
        u'events.cumulativematchscore': {
            'Meta': {'unique_together': "(('user', 'event'),)", 'object_name': 'CumulativeMatchScore'},
        ...
        u'events.event': {
            ...
            'event_photo': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
        ...
        u'events.membership': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 5, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_facebook.FacebookCustomUser']"})
        }
    }
