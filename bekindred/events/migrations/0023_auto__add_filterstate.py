...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FilterState'
        db.create_table(u'events_filterstate', (
            ...
            ('distance_unit', self.gf('django.db.models.fields.CharField')(default='miles', max_length=5)),
            ('cumulative_match_score', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('gender', self.gf('django.db.models.fields.CharField')(default='m,f', max_length=3)),
        ...
        db.send_create_signal(u'events', ['FilterState'])


    def backwards(self, orm):
        # Deleting model 'FilterState'
        db.delete_table(u'events_filterstate')
    ...
    models = {
        ...
        u'events.membership': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 24, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_facebook.FacebookCustomUser']"})
        }
    }
