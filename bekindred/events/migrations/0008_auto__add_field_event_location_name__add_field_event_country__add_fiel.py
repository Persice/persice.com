...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'events_event', 'location_name',
        ...
        # Adding field 'Event.full_address'
        db.add_column(u'events_event', 'full_address',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'events_event', 'location_name')

        # Deleting field 'Event.country'
        db.delete_column(u'events_event', 'country')

        # Deleting field 'Event.full_address'
        db.delete_column(u'events_event', 'full_address')
    ...
    models = {
        ...
        u'events.membership': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 17, 0, 0)'}),
