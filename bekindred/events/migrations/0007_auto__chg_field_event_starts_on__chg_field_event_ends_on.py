...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_event', 'starts_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 6, 12, 0, 0)))

        # Changing field 'Event.ends_on'
        db.alter_column(u'events_event', 'ends_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 6, 12, 0, 0)))
    ...
    models = {
        ...
        u'events.membership': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 12, 0, 0)'}),
